...
namespace Infrastructure.ObjectModel
{
    ...
    {
        private CollidableType m_CollidableType;
        public CollidableType CollidableType
        {
            get { return m_CollidableType; }
            set { m_CollidableType = value; }
        }
        ...
        {
            Texture2D texture = new Texture2D(this.Game.GraphicsDevice, this.Texture.Width, this.Texture.Height);
            Color[] pixels = new Color[(int)(this.Texture.Width * this.Texture.Height)];
        ...
        public override void Draw(GameTime gameTime)
        {
            if (!m_UseSharedBatch)
            {
                ...
                m_SpriteBatch.Begin(
                    SortMode, BlendState.NonPremultiplied
                    , SamplerState,
